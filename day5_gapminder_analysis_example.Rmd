...
putting a hyperlink - 
[our course website](https://babeheim.com/2021-11-29-leipzig-online/)
...
use the navigation bar to see document outline
...
talk about making a setup code chunk in the beginning for global options and packages and such
...
- kableExtra (extra formatting for kable package)
- pander
...
we need a latex installation, make using tinytex package
...
or open a new default file

use the rticles package

install.packages("rticles")

### citations

just quickly mention how it works:

yaml:
bibliography: mybibfile.bib
csl: elsevier-vancouver.csl

then use [@Dirac1953888] syntax for citations
...
papers using docx output
-	La Ferrassie osf: https://osf.io/sfnb8/
- BK manuscript osf: https://osf.io/tk9dc/
